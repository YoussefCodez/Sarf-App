...
class AuthRemoteDataSource {
  ...
  Future<void> insertData({required String table, required Map<String, dynamic> data}) {
  ...
  Future<Map<String, dynamic>> selectSingle({required String table, required String column, required dynamic value}) {
