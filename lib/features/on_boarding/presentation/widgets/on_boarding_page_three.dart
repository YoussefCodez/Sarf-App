...
import 'package:finance_tracking/features/on_boarding/presentation/view/providers/end_on_boarding_provider.dart';
...
import 'package:finance_tracking/features/on_boarding/presentation/widgets/spend_chips_row.dart';
          ...
          SliverFillRemaining(
            ...
            child: Column(
              children: [
                ...
                ).animate().fadeIn(duration: Duration(milliseconds: 600)).slideY(begin: 0.1, duration: Duration(milliseconds: 600)),
                Gap(32.h),
                Container(
                ...
                ).animate().fadeIn(delay: Duration(milliseconds: 200), duration: Duration(milliseconds: 600)).slideY(begin: 0.1, duration: Duration(milliseconds: 600)),
                Gap(16.h),
                SpendChipsRow().animate().fadeIn(delay: Duration(milliseconds: 400), duration: Duration(milliseconds: 600)).slideY(begin: 0.1, duration: Duration(milliseconds: 600)),
                Gap(16.h),
                InfoCard(
                ...
                ).animate().fadeIn(delay: Duration(milliseconds: 600), duration: Duration(milliseconds: 600)).slideY(begin: 0.1, duration: Duration(milliseconds: 600)),
                const Spacer(),
                Consumer(
                  builder: (context, ref, child) {
                ...
                ).animate().fadeIn(delay: Duration(milliseconds: 800), duration: Duration(milliseconds: 600)).slideY(begin: 0.1, duration: Duration(milliseconds: 600)),
                Gap(16.h),
                Consumer(
                  builder: (context, ref, child) {
                    return TextButton(
                ...
                ).animate().fadeIn(delay: Duration(milliseconds: 900), duration: Duration(milliseconds: 600)).slideY(begin: 0.1, duration: Duration(milliseconds: 600)),
              ],
            ),
          ),
        ],
